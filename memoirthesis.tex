...
\setlength{\beforechapskip}{0pt}     % Убирает отступ ПЕРЕД заголовком главы
\setlength{\midchapskip}{0pt}        % Убирает промежуток между номером и названием
\setlength{\afterchapskip}{10pt}     % Отступ после заголовка (можно тоже 0pt)
% 
%
% 
\frontmatter
\pagestyle{plain} % ❗ Отключает заголовки и колонтитулы на всех frontmatter-страницах
...
% \clearemptydoublepage
%
\import{chapters}{problem-statement.tex}
% \clearemptydoublepage
%
\import{chapters}{main.tex}
%
\import{chapters}{conclusion.tex}
%
% And the appendix goes here
\appendix
\import{chapters}{app0A.tex}
%\clearemptydoublepage
%
